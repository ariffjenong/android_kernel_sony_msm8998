...
static unsigned int default_up_delay_lp[] = {1500};

static unsigned int default_efficient_freq_hp[] = {2112000, 2323200};
static unsigned int default_up_delay_hp[] = {50, 1500};
